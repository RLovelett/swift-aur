...
sha256sums=(
  ...
  'd2f6496eead79bf33503600373b9bf8fd3ae9ce01075e2f777d232223ad5700f'
...
package() {
  "$srcdir/swift/utils/build-script" --preset=buildbot_arch_linux installable_package="./swift-$pkgver.tar.gz" install_destdir="$pkgdir/"
}
